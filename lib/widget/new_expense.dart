...
class _NewExpenseState extends State<NewExpense> {
 ...
 void _presentDatePicker() async{
  ...
  final pickedDate=await showDatePicker(context: context, initialDate: now, firstDate: firstDate, lastDate: DateTime.now());
   setState(() {
 ...
 @override
  void dispose() {
    ...
    _amountController.dispose();// TODO: implement dispose
    super.dispose();
  }
  @override
